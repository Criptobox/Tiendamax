...
function injectStyles(){
  ...
  st.textContent = `
  html.tm-copilot-enabled #tmBtnPendientes{border-color:rgba(139,92,246,.45)!important;background:rgba(139,92,246,.14)!important;color:#d9c8ff!important}
...
@media (min-width:1100px){body.tm-copi-col .tm-copilot-sheet.show{top:0;bottom:0;right:0;height:100vh;max-height:100vh;width:430px;border-radius:0;border-right:0;border-top:0;border-bottom:0;box-shadow:-22px 0 60px rgba(0,0,0,.5)}body.tm-copi-col .content{padding-right:446px}body.tm-copi-col .tm-copilot-bubble{display:none}}
  ...
  .tcp2-cta-t{color:#fff;font-weight:800;font-size:17px;line-height:1.2}.tcp2-cta-t small{display:block;font-size:11px;font-weight:700;letter-spacing:.06em;opacity:.9}
...
function openSheet(){ ensureUI(); renderSheet(); $('#tmCopilotSheet').classList.add('show');
  document.body.classList.add('tm-copi-col');
  localStorage.setItem(LS.opened, DAY); }
function closeSheet(){ const s=$('#tmCopilotSheet'); if(s) s.classList.remove('show');
  document.body.classList.remove('tm-copi-col'); }
...
function _cartelDataFromProduct(p){
  ...
  return {
    ...
    url: p.id ? 'https://tiendamax.org/p/producto-'+p.id+'.html' : 'https://tiendamax.org'
  };
}
...
function _cartelHTML2(d){
  ...
  return `<div class="tcp2-root" style="--tc-a:${color};--tc-a-rgb:${colorRgb}">`
    ...
    +`<div class="tcp2-cta"><div class="tcp2-cta-wa"><svg viewBox="0 0 24 24" fill="#25d366"><path d="M12 2C6.5 2 2 6.5 2 12c0 1.8.5 3.5 1.3 5L2 22l5.2-1.3c1.4.8 3.1 1.3 4.8 1.3 5.5 0 10-4.5 10-10S17.5 2 12 2z"/></svg></div><div class="tcp2-cta-t"><small>PÍDELO POR</small>WhatsApp</div><div class="tcp2-cta-arrow">›</div></div>`
