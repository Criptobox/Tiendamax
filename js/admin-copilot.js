...
/* El generador de carteles (cuatro plantillas HTML + html2canvas) vivía aquí
   y se quitó entero: las imágenes de Facebook, del Estado de WhatsApp y de los
   lotes por categoría las dibuja ahora el mismo lienzo que el anuncio de
   Revólico —tmAnuncioImagen(), en js/revolico_integration.js—, que no depende
   de inyectar CSS ni de fotografiar un nodo escondido.

   De todo aquello solo sobrevive la tabla de colores por categoría de aquí
   abajo, porque es la que le da el tono de fondo a ese lienzo. */
