...
// subirImagenAGitHub → implementación en script-admin.js
async function subirImagenAGitHub(s) { return typeof s === 'string' ? s : ''; }
...
// ===== AUTENTICACIÓN / PANEL ADMIN (implementación en script-admin.js) =====
function cerrarLoginModal() {}
async function verificarPassword(e) { if (e) e.preventDefault(); }
...
function switchTab() {}
async function agregarProductoForm(e) { if (e) e.preventDefault(); }
function guardarProductos() {}
function comprimirImagen(s) { return Promise.resolve(typeof s === 'string' ? s : ''); }
function descargarProductosJSON() {}
async function sincronizarConBackend() { return false; }
...
// subirMultiplesImagenes → implementación en script-admin.js
async function subirMultiplesImagenes() { return []; }
...
// ===== PUBLICACIÓN FB/REVOLICO + SELECTS ADMIN (implementación en script-admin.js) =====
function copiarParaRevolico() {}
function copiarParaFacebook() {}
function prepararPublicacionManual() {}
async function publicarEnRevolico() {}
...
// ===== GESTIÓN CATEGORÍAS/PRODUCTOS/SYNC GITHUB (implementación en script-admin.js) =====
...
function _renderEditGallery() {}
function _renderEditRecomendados() {}
function abrirEditModal() {}
function cerrarEditModal() {}
async function guardarProductoEditado(e) { if (e) e.preventDefault(); }
async function verificarEstadoBackend() {}
async function cargarEstadoPublicacion() {}
function cargarConfiguracionGitHub() {}
function guardarConfiguracionGitHub(e) { if (e) e.preventDefault(); }
function marcarProductoModificado() {}
function limpiarProductosModificados() {}
function obtenerProductosModificados() { return []; }
