(function(){"use strict";if(window._tmBotLoaded||location.pathname.includes("/admin"))return;window._tmBotLoaded=!0;function C(){const t=document.querySelector('meta[name="tm-bot-cerebro"]');return t&&t.content?t.content:"js/tm-bot-cerebro.js"}let d=!1,c=!1,f=!1,u=!1;const h=document.createElement("style");h.textContent=`
    ...
    `,document.head.appendChild(h);const e=document.createElement("button");e.className="tm-bot-bubble",e.id="tmBotBubble",e.setAttribute("aria-label","Abrir chat con Max"),e.innerHTML='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2C6.48 2 2 6.48 2 12c0 1.86.51 3.6 1.39 5.09L2 22l4.91-1.39C8.4 21.49 10.14 22 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2zm0 18c-1.66 0-3.22-.45-4.56-1.24l-.33-.2-2.92.83.83-2.92-.2-.33C3.45 15.22 3 13.66 3 12c0-4.96 4.04-9 9-9s9 4.04 9 9-4.04 9-9 9zm5-9.5c0 2.49-2.01 4.5-4.5 4.5-.78 0-1.51-.2-2.15-.55L8 15.5l1.05-2.35C8.7 12.51 8.5 11.78 8.5 11c0-2.49 2.01-4.5 4.5-4.5S17 8.51 17 11z"/></svg><span class="tm-bot-badge" aria-hidden="true">1</span>',document.body.appendChild(e);const s=document.createElement("button");s.type="button",s.className="tm-bot-label",s.textContent="Preg\xFAntale a Max",s.addEventListener("click",()=>e.click()),document.body.appendChild(s);const i=document.createElement("div");i.className="tm-bot-welcome",i.id="tmBotWelcome",i.innerHTML='<button class="tm-bot-welcome-close" aria-label="Cerrar">\xD7</button><div class="tm-bot-welcome-avatar">\u{1F916}</div><div class="tm-bot-welcome-txt"><b>Max \xB7 Asistente</b><br>\xBFBuscas algo? Preg\xFAntame lo que sea \u{1F44B}</div>',document.body.appendChild(i);const o=document.createElement("div");o.className="tm-bot-panel",o.id="tmBotPanel",o.setAttribute("role","dialog"),o.setAttribute("aria-label","Chat con Max, asistente de TiendaMax"),o.innerHTML=`
    ...
    `,document.body.appendChild(o);const m=o.querySelector("#tmBotBody"),l=o.querySelector("#tmBotInput"),B=o.querySelector("#tmBotClose"),w=i.querySelector(".tm-bot-welcome-close");function y(t,a){const r=document.createElement("div");return r.className="tm-bot-msg bot",r.id=a||"",r.innerHTML=t,m.appendChild(r),m.scrollTop=m.scrollHeight,r}function b(){if(window._tmBotCerebroListo||c)return;c=!0,f=!1;const t=document.createElement("script");t.src=C(),t.defer=!0,t.onerror=()=>{c=!1,f=!0;const a=document.getElementById("tmBotCargando");a&&a.remove();const r=typeof getNumeroWhatsApp=="function"?getNumeroWhatsApp():"5354320170";y('\u{1F615} No pude cargar el asistente (parece que la conexi\xF3n fall\xF3). Puedes reintentar o escribirnos directo por WhatsApp: <a class="tm-bot-link" href="https://wa.me/'+r+'" target="_blank" rel="noopener noreferrer">wa.me/'+r+"</a>");const g=document.getElementById("tmBotQuickReplies");if(g){g.innerHTML="";const x=document.createElement("button");x.className="tm-bot-quickreply",x.textContent="\u{1F504} Reintentar",x.onclick=()=>{g.innerHTML="",m.innerHTML="",n()},g.appendChild(x)}},document.head.appendChild(t)}["mouseenter","touchstart","focus"].forEach(t=>{e.addEventListener(t,b,{once:!0,passive:!0})}),window._tmBotAlCargarCerebro=function(){c=!1;const t=document.getElementById("tmBotCargando");if(t&&t.remove(),!u)return;try{window._tmBot.open()}catch(r){}const a=window._tmBotPendiente;if(window._tmBotPendiente=null,a)try{window._tmBot.send(a)}catch(r){}};function n(){u=!0,o.classList.add("open"),d=!0,e.classList.remove("has-new");const t=e.querySelector(".tm-bot-badge");if(t&&t.remove(),i.classList.remove("visible"),window._tmBotCerebroListo){try{window._tmBot.open()}catch(a){}return}!document.getElementById("tmBotCargando")&&!f&&y("\u{1F44B} Un segundo, estoy despertando\u2026","tmBotCargando"),b(),setTimeout(()=>{try{l.focus()}catch(a){}},300)}function p(){o.classList.remove("open"),d=!1}e.onclick=()=>{d?p():n()},B.onclick=p,w.onclick=t=>{t.stopPropagation(),i.classList.remove("visible")},i.addEventListener("click",t=>{t.target!==w&&n()});function v(){if(window._tmBotCerebroListo)return;const t=(l.value||"").trim();t&&(window._tmBotPendiente=t,l.value=""),b()}o.querySelector("#tmBotSend").onclick=v,l.addEventListener("focus",b,{once:!0}),l.addEventListener("keydown",t=>{t.key==="Enter"&&!window._tmBotCerebroListo&&(t.preventDefault(),v())}),document.addEventListener("keydown",t=>{t.key==="Escape"&&d&&!window._tmBotCerebroListo&&p()});function k(){sessionStorage.getItem("tm_bot_welcome_shown")||setTimeout(()=>{d||(sessionStorage.setItem("tm_bot_welcome_shown","1"),e.classList.add("has-new"))},4e3)}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",k):k(),window._tmBot=window._tmBot||{open:n,close:p,send:t=>{n(),window._tmBotPendiente=t}},window._tmBotCascara={abrir:n,cerrar:p,cargarCerebro:b}})();
