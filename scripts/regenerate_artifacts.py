...
#   - `g` es la marca del GRUPO de Facebook desde el que se publicó
#     (tmGrupoCodigo en js/revolico_integration.js): la visita y el toque en
#     WhatsApp se suman también en /analytics/grupos/<g>, para ver qué grupo
